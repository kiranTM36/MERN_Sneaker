...
const Navbar = () => {
  return (
    <div className='fixed top-0 left-0 w-full z-10 flex items-center justify-center'>
        <div className='flex justify-between w-full items-center h-[10vh] px-12 bg-white'>
            ...
            <div className=' flex gap-2 items-center'>
                ...
                <button className='border py-1.5 px-2 rounded-md bg-black text-white hover:bg-white hover:text-black'>Sign Up</button>
                <button className='border py-1.5 px-2 rounded-md hover:bg-black hover:text-white'>Login</button>
            </div>
        </div>
    </div>
  )
